  ...
  <body>
    ...
    <div class="container">
      <section class="rejestracja">
        <article>
          <h1>LOGUJESZ SIĘ JAKO UŻYTKOWNIK</h1>
          <a href="logowaniePracodawca.php"><p>ZALOGUJ SIĘ JAKO PRACODAWCA</p></a><br>
          ...
          <?php 
            ...
            if (isset($_POST["login"]) && !empty($_POST["login"]) && isset($_POST["haslo"]) && !empty($_POST["haslo"])) {
              ...
              $zapytanie = "SELECT Login, Haslo FROM uzytkownik WHERE Login = '$login' AND Haslo = '$haslo'";
              ...
              if ($zlicz != 1) {
                ...
                $zapytanieUzytkownik = "SELECT id_Uzytkownik FROM uzytkownik WHERE Login = '$login'";
                ...
                if(!$wynik = $baza -> query($zapytanieUzytkownik)){
                  ...
                  $_SESSION['idU'] = $row['id_Uzytkownik'];
