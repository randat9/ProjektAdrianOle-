  ...
  <body>
    ...
    <div class="container">
      <section class="rejestracja">
        <article>
          <h1>ZAREJESTUJESZ SIĘ JAKO UŻYTKOWNIK</h1>
          <a href="rejestracjaPracodawca.php"><p>ZAREJESTRUJ SIĘ JAKO PRACODAWCA</p></a><br>
          <form class="wyszukaj" method="post">
            ...
            if (isset($_POST["email"]) && !empty($_POST["email"]) && isset($_POST["login"]) && !empty($_POST["login"]) && isset($_POST["haslo"]) && !empty($_POST["haslo"] && isset($_POST["powtorz"]) && !empty($_POST["powtorz"]) && $_POST['haslo'] == $_POST['powtorz'])) {
              ...
              if (!$baza->query("INSERT INTO uzytkownik(id_Uzytkownik, Login, Haslo, Email) VALUES ('NULL', '$login', '$haslo', '$email')")) {
